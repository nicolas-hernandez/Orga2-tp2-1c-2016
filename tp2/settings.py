...
class Tests:
    ...
    def printAllInfo():
        ...
        print str(Tests.clocksLdr) + ": clocks ldr test. flags and version are ignored \n"
        print str(Tests.clocksCf) + ": clocks cropflip test. flags and version ignored \n"
        print str(Tests.clocksSep) + ": clocks sepia test. flags and version ignored \n"
