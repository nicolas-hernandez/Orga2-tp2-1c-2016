...
\fancyfoot[LO]{\small{Kapobel Rodrigo, Nicolas Hernandez, Bruno Ignani}}
\fancyfoot[RO]{\thepage}
...
\integrante{Bruno Ignani}{50/13}{chino117@hotmail.com}
...
\subsection{Comportamiento: Aumentando resoluciones}
\input{testSizes.tex}

\newpage

\subsection{Performance: filtros e implementaciones}
\input{testTiempos.tex}
\newpage

\subsection{Performance caché: caliente vs. fria}
\input{testCache.tex}
\newpage
